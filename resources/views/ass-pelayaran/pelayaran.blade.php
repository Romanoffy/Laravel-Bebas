...
<body>
  <header style="position: absolute; top: 0; left: 0; padding: 10px; margin-top: 15px; color:azure;">
    <h1>Latihan soal (Pelayaran Bangsa Barat Ke Indonesia)</h1>
  </header>
  ...
  <div class="wrapper">
    <header>
      <h4>Latihan Soal (Pelayaran Bangsa Barat Ke Indonesia)</h4>
      <div class="Timer">
        <p>Waktu Tersisa</p>
        <p>15</p>
      </div>
  ...
  <script>let startBtn = document.querySelector(".start-btn"),
...
const questions = [  
  {   
    question: "Apa tujuan utama pelayaran bangsa Barat menuju Indonesia?",    
    options: ["Mencari rute perdagangan rempah-rempah", "Menyebarkan agama Kristen", "Menaklukkan kerajaan-kerajaan di Indonesia", "Menjalin hubungan diplomatik"],
    answer: "0"
  },
  {
    question: "Siapakah pelaut Portugis yang pertama kali sampai di Malaka pada tahun 1511?",
    options : ["Ferdinand Magellan", "Vasco da Gama", "Alfonso de Albuquerque", "Bartolomeu Dias"],
    answer: "2"
  },
  {
    question: "Negara mana yang pertama kali menguasai Malaka?",
    options: ["Spanyol", "Belanda AJA", "Ingriss", "Portugis"],
    answer: "3"
  },
  {
    question: "Pada tahun berapa Cornelis de Houtman tiba di Banten?",
    options: ["1592", "1596", "1602", "1605"],
    answer: "1"
  },
  {
    question: "Apa yang menyebabkan pelayaran bangsa Barat menuju Indonesia pada abad ke-15 dan 16?",
    options: ["Jatuhnya Konstantinopel", "Konflik di Eropa", "Kekayaan rempah-rempah di Indonesia", "Revolusi Industri"],
    answer: "0"
  },
