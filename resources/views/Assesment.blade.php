...
<body>
     ...
     <nav class=" bg-gradient shadow mb-5 py-3">
        ...
        <div class="container">
            <a class="navbar-brand fw-bold" >Assessment</a>
    ...
    <div class="container my-5">
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                ...
                <div class="card shadow-sm border-light h-100 d-flex flex-column card-container">
                    ...
                    <div class="card-body d-flex flex-column">
                      ...
                      <div class="btn-group mt-auto">
                          <!-- Tombol Baca Materi -->
                          <a href="{{ url('/voc') }}"  class="btn btn-custom">
                              <i class="fas fa-book-open me-2"></i>Latihan Soal
                          </a>
            ...
            <!-- Kartu Kedua: Pelayaran Bangsa Barat -->
            <div class="col">
                <div class="card shadow-sm border-light h-100 d-flex flex-column card-container">
                    ...
                    <div class="card-body d-flex flex-column">
                      ...
                      <div class="btn-group mt-auto">
                          <!-- Tombol Baca Materi -->
                          <a href="/pelayaran" class="btn btn-custom">
                              <i class="fas fa-book-open me-2"></i>Latihan Soal
                          </a>
            ...
            <!-- Kartu Ketiga: Kolonialisme dan Perlawanan -->
            <div class="col">
               <div class="card shadow-sm border-light h-100 d-flex flex-column card-container">
                   ...
                   <div class="card-body d-flex flex-column">
                       ...
                       <div class="btn-group mt-auto">
                           <!-- Tombol Baca Materi -->
                           <a href="/kolonialisme" class="btn btn-custom">
                               <i class="fas fa-book-open me-2"></i>Latihan Soal
                           </a>
                           <!-- Tombol Kembali ke Home -->
            ...
            <!-- Tambah lebih banyak kartu sesuai kebutuhan -->
       </div>
    </div>
