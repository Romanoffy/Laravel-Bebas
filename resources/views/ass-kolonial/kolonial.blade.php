...
<body>
  <header style="position: absolute; top: 0; left: 0; padding: 10px; margin-top: 15px; color:azure;">
    <h1>Latihan soal (Kolonialisme & Perlawanan Indonesia)</h1>
  </header>
  ...
  <div class="wrapper">
    <header>
      <h4>Latihan Soal (Kolonialisme & Perlawanan Indonesia)</h4>
      <div class="Timer">
        <p>Waktu Tersisa</p>
        <p>15</p>
      </div>
...
const questions = [  
  {   
    question: "Perlawanan Diponegoro terhadap Belanda terjadi pada tahun?",    
    options: ["1825-1830", "1815-1820", "1830-1835", "1840-1845"],
    answer: "0"
  },
  {
    question: "Siapa pemimpin perlawanan rakyat Aceh terhadap Belanda?",
    options: ["Sultan Hasanuddin", "Teuku Umar", "Pangeran Antasari", "Pattimura"],
    answer: "1"
  },
  {
    question: "Apa yang menjadi penyebab utama perlawanan rakyat Tapanuli di bawah pimpinan Sisingamangaraja XII?",
    options: ["Penjajahan Belanda", "Paksaan untuk memeluk agama Kristen", "Pajak yang tinggi", "Perebutan wilayah"],
    answer: "0"
  },
  {
    question: "Apa nama perlawanan rakyat Maluku yang dipimpin oleh Pattimura pada tahun 1817?",
    options: ["Perang Aceh", "Perang Diponegoro", "Perang Padri", "Perang Pattimura"],
    answer: "3"
  },
  {
    question: "Apa kebijakan tanam paksa yang diterapkan oleh Belanda di Indonesia?",
    options: ["Rakyat Indonesia diwajibkan ikut serta dalam militer Belanda", "Rakyat Indonesia dibebaskan dari pajak sebagai imbalan kerja", "Rakyat Indonesia dipaksa untuk menanam komoditas yang ditentukan oleh pemerintah Belanda", "Rakyat Indonesia diwajibkan menyerahkan sebagian hasil panen"],
    answer: "2"
  },
